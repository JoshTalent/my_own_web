...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',    href: 'https://rw.linkedin.com/in/josue-ntwari-111289338', 
    ...
    {
      name: 'Twitter',    href: 'https://x.com/josh_talent123', 
  ...
  const professionalLinks = [
    ...
    {
      name: 'Blog',
      href: 'https://josuentwali.netlify.app',
      icon: (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9m0 0v12m0-12a2 2 0 012-2h2a2 2 0 012 2m-6 6h6"/>
        </svg>
      )
    }
  ];
  ...
  return (
    <footer className="bg-gray-900 text-white">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center">
                <span className="text-gray-900 font-bold text-lg">JN</span>
              </div>
            ...
            <div className="flex space-x-4 mb-6">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="bg-gray-800 hover:bg-gray-700 p-3 rounded-lg transition-all duration-200 hover:scale-110"
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            {/* Copyright */}
            <div className="text-gray-400 text-sm">
              © {currentYear} Josue Ntwali. All rights reserved.
            </div>
      ...
      <button
        ...
        className="fixed bottom-8 right-8 bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-full shadow-lg transition-all duration-200 hover:scale-110 z-40"
